...
from slam.Variables import Variable, R2Variable, VariableType, R1Variable, SE2Variable, Bearing2DVariable
...
class R2RelativeGaussianLikelihoodFactor(ExplicitLikelihoodFactor, BinaryFactor,
                                         BinaryLinearGaussianRelativeLikelihoodFactor, R2LikelihoodFactor, OdomFactor):
    measurement_dim = 2
...
class SE2RelativeGaussianLikelihoodFactor(ExplicitLikelihoodFactor, BinaryFactor,
                                          BinaryLinearGaussianRelativeLikelihoodFactor, R2LikelihoodFactor, OdomFactor):
    """
...
class SE2BearingLikelihoodFactor(ExplicitLikelihoodFactor, BinaryFactor, OdomFactor):
    """
...
class UnaryFactorMixture:
    def __init__(self,
                 var: Variable,
                 weights: np.ndarray,
                 factors: List[Factor]):
        super().__init__(weights, factors)
        self._vars = [var]
